...
class Policy(object):
    def __init__(self, obs_dim, act_dim, kl_targ, hid1_mult, init_logvar):
        ...
        self.trpo = TRPO(obs_dim, act_dim, hid1_mult, kl_targ, init_logvar, eta) # initialize TRPO agent
    ...
    def update(self, observes, actions, advantages, logger):
        ...
        # Many numbers obtained empirically: we use beta to reach KL target
...
# Neural network for policy approximation function
